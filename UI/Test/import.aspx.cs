...
public partial class Test_import : System.Web.UI.Page
{
    ...
    protected void Btn1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string strcon = "Data Source=.;Initial Catalog=SDBISAS;uid=sa;pwd=12358;";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (t1 != "" && t2 != "" && t3 != "" && t4 != "")
                {
                    SqlCommand selectcmd = new SqlCommand("select count(*) from Test where t1='" + t1 + "' and t2='" + t2 + "' and t3='" + t3 + "' and t4='" + t4 + "'", conn);
                    ...
                    {
                        SqlCommand insertcmd = new SqlCommand("insert into Test(t1,t2,t3,t4) values('" + t1 + "','" + t2 + "','" + t3 + "','" + t4 + "')", conn);
