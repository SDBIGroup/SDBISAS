            ...
            <div class="box png">
                ...
                <div class="input">
                    <div class="log">
                        ...
                        <div class="name">
                            验证码
                         <asp:TextBox type="text" class="text" ID="value_3" placeholder="验证码" name="value_2" TabIndex="2" runat="server" Width="106px"></asp:TextBox>
                            <img src="VCode.aspx" alt="Alternate Text" style="width: 80px; height: 20px" onclick="this.src=this.src+'?'" />
                        </div>
